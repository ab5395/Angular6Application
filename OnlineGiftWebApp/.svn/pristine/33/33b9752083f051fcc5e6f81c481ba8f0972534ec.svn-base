...
var LocationHelper = /** @class */ (function () {
    ...
    LocationHelper.prepareLocationData = function (place) {
        ...
        if (place.geometry.viewport != null) {
            ...
            var viewport_custom_1 = {};
            viewport_custom_1.viewport_northeast_lat = viewport.getNorthEast().lat().toString();
            viewport_custom_1.viewport_northeast_lng = viewport.getNorthEast().lng().toString();
            viewport_custom_1.viewport_southwest_lat = viewport.getSouthWest().lat().toString();
            viewport_custom_1.viewport_southwest_lng = viewport.getSouthWest().lng().toString();
        }
        var locationObject = {
