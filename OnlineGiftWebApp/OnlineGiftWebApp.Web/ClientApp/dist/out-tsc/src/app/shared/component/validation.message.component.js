...
var ControlMessagesComponent = /** @class */ (function () {
    ...
    Object.defineProperty(ControlMessagesComponent.prototype, "errorMessage", {
        get: function () {
            var error = this.control.errors;
            if (error != null) {
                for (var propertyName in error) {
                    if (error.hasOwnProperty(propertyName) && this.control.touched) {
                        return validation_service_1.ValidationService.getValidatorErrorMessage(propertyName, error[propertyName]);
                    }
                }
            }
            return null;
    ...
    ], ControlMessagesComponent.prototype, "msg", void 0);
